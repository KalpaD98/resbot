...
#         """Preprocess the training data. Retrieve only the intents and save them to a CSV file."""
#         print("Saving unique intents for FewShotGPTIntentClassifier to a CSV file")
#
#         unique_intents = set()
#         data = []
#
...
#                 data.append({"intent": intent, "explanation": ""})
#
